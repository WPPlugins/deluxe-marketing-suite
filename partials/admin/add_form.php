                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div id="display_setting_item" class="panel-collapse collapse in">
                                        <div class="panel-body">
                                                    ...
                                                    <?php if(isset($lists['lists']['items']) && count($lists['lists']['items'])){?>
                                                        <?php foreach($lists['lists']['items'] as $item){?>
                                                            <?php if(strtolower($item['attributes']['name'])=='all contacts'){?>
                                                                <option value="<?php echo $item['attributes']['id'];?>" <?php if(isset($_POST['dms_contect_list_id'])){ selected($_POST['dms_contect_list_id'],$item['attributes']['id'],true);}?>><?php echo $item['attributes']['name'];?></option>
                                                            <?php }?>
                                                        <?php }?>
                                                        <?php foreach($lists['lists']['items'] as $item){?>
                                                            <?php if(strtolower($item['attributes']['name'])!='all contacts'){?>
                                            ...
                                            <div class="form-group">
                                                <label for="dms_show_as_embed"><input type="checkbox" value="1" name="dms_show_as_embed" id="dms_show_as_embed" <?php checked((isset($_POST['dms_show_as_embed'])?$_POST['dms_show_as_embed']:1),1,true);?> >&nbsp;<?php _e('Show as embed in page/sidebar',DMS_NAME);?>
                                                    <br/><small style="margin-left: 20px; font-weight: normal;"><i>shortcode to be appended must include  "[ ]"</i></small>
                                                </label>
                                                 
                                            </div>
                                            <div class="form-group">
                                                <label for="dms_show_as_popup"><input type="checkbox" value="1" name="dms_show_as_popup" id="dms_show_as_popup" <?php checked((isset($_POST['dms_show_as_popup'])?$_POST['dms_show_as_popup']:1),1,true);?> >&nbsp;<?php _e('Show as pop-up',DMS_NAME);?></label>
                                                <br>
                                                <small></small>
                                            </div>
                                            ...
                                            <div class="form-group show_as_popup_div">
                                                <label for="dms_show_popup_in_homepage"><input type="checkbox" value="1" name="dms_show_popup_in_homepage" id="dms_show_popup_in_homepage" <?php checked((isset($_POST['dms_show_popup_in_homepage'])?$_POST['dms_show_popup_in_homepage']:0),1,true);?>>&nbsp;<?php _e('Show pop-up/bar on homepage',DMS_NAME);?></label>
                                            </div>
                                            <div class="form-group show_as_popup_div">
                                            ...
                                            <div class="form-group show_as_popup_div">
                                                ...
                                                <br/>
                                                <label for="form_show_befor_login"><input type="radio" name="form_display_befor_after_login" id="form_show_befor_login" value="0" checked="checked"> <?php _e('Befor login',DMS_NAME);?></label>&nbsp;&nbsp;
                                            ...
                                            <div class="form-group show_as_popup_div">
                                                <label for="form_width"><?php _e('Form width (only for pop-up)',DMS_NAME);?></label>
                                    ...
                                    <div id="general_setting_item" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12 ">
                                                        <label for="button_shape_sharp_edge"><input type="radio" name="button_shape" id="button_shape_sharp_edge" value="0" <?php if(isset($_POST['button_shape'])){ checked($_POST['button_shape'],0,true);}?>>&nbsp;<?php _e('Rectangle with sharp edges',DMS_NAME);?></label>
                                                    </div>
                                                    <div class="col-xs-12">
                                                        <label for="button_shape_smooth_edge"><input type="radio" name="button_shape" id="button_shape_smooth_edge" value="1" <?php if(isset($_POST['button_shape'])){ checked($_POST['button_shape'],1,true);}else{checked(1,1,true);}?>>&nbsp;<?php _e('Rectangle with smooth edges',DMS_NAME);?></label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
